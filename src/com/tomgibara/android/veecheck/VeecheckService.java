...
/**
 * An abstract base class for {@link Service}s that perform the task of checking for new application versions.
 * Extensions should implement the {@link #createNotifier()} method.
 * 
 * @author Tom Gibara
 */
...
public abstract class VeecheckService extends Service {
    ...
    /**
     * This handler is used to post back a {@link Runnable} that responds to the termination of a {@link VeecheckThread }
     * .
     */
    ...
    /**
     * Records the currently running {@link VeecheckThread}. Only one such thread should be existent at any given time;
     * there is no sensible reason to concurrently check for updates to a single application.
     */
    ...
    /**
     * Concrete extensions of this class should implement this method to provide a {@link VeecheckNotifier} that can be
     * used when intent information has been obtained for the current application version.
     * 
    ...
    /**
     * Supplies an object that can persist the state information needed by {@link VeecheckService} within the given
     * context.
     * 
    ...
    /**
     * This method called by a {@link VeecheckThread} immediately prior to its termination.
     * 
    ...
    /**
     * Do the work of notifying the user that a new version of the application is available (if necessary).
     * 
